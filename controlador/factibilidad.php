...
<?php 
include_once '../clases/Cultivo.php';
$prueba=new Cultivo();
 #$m=new Cultivo();

#$m->calculafactibilidadzonamanual(20,20,20,20, 20, 29, 22,22,22,6,'Tux');
$res=$prueba->calculafactibilidadzonamanual($_POST['hrmin'],$_POST['hrmax'], $_POST['HR'],$_POST['pre_pluvial'], $_POST['pre_pluvialmin'], $_POST['pre_pluvialmax'],$_POST['tempMax'],$_POST['tempMin'],$_POST['tempRecomendada'],$_POST['id'],$_POST['nombre']);
?>
                </div>
